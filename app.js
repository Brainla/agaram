...
database.collection("agaram").find({
            articlestatus: false,adminStatus:false
        }).toArray(function(err, result) {
    console.log(result+87)
   var works =  JSON.stringify(result)
    console.log(works);
      var work = JSON.parse(works)
     console.log(work);
for (i in work){
        console.log(work[i]["empid"])
        arr.push(work[i]["empid"])
     }
...
for (item in hello) {
    ...
    var passwords = hello[item]["Password"]
...
database.collection("agaram").find({
   ...
   var works =  JSON.stringify(result)
    console.log(works);
     ...
     console.log(work);
for (i in work){
        console.log(work[i]["articlename"])
        arr.push(work[i]["articlename"])
     }
// console.log(arr)
for (item in hello) {
